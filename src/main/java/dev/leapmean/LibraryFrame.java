...
public class LibraryFrame extends JFrame {
    ...
    public LibraryFrame(User user) {
        ...
        JMenu file = new JMenu("Library");
        JMenuItem refresh = new JMenuItem("View Books");
        JMenuItem add = new JMenuItem("Add Book");
        JMenuItem update = new JMenuItem("Edit Book");
        JMenuItem delete = new JMenuItem("Remove Book");
